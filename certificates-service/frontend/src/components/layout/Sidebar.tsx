...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`flex flex-col bg-slate-900 border-r border-slate-700/50 transition-all duration-200 ${
        collapsed ? "w-16" : "w-56"
      }`}
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-700/50">
        ...
        {!collapsed && (
          <span className="font-bold text-slate-100 text-sm">MetalCert</span>
        )}
        <button
